...
In the [next part](projects/hack-zsun-for-openwrt-captive-portal-part-2//) of this series, we'll set the device up as a PHP Web Server that acts as a custom captive portal.
...
In [part 2](projects/hack-zsun-for-openwrt-captive-portal-part-2/), we'll dive deep and set up the PHP web server & captive portal on top of what we've built.
